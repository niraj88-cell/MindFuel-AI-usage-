...
function StatCard({ icon: Icon, color, bg, value, label }: {
  ...
  return (
    <div className={`flex flex-col items-center justify-center p-6 rounded-3xl ${bg} border border-white/10 text-center`}>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 pb-20 stagger-children">
      ...
      <div className="relative">
        ...
        <div className="relative bg-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-[28px] p-6">
          <div className="flex items-center gap-5">
            {/* Avatar */}
            <div className="relative">
              <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-indigo-500/30 to-purple-500/30 border border-white/10 flex items-center justify-center text-3xl font-black text-indigo-300">
                {initials}
              </div>
              {isPremium && (
      ...
      <div className="grid grid-cols-2 gap-3">
        <StatCard icon={Brain} color="text-white" bg="bg-indigo-500/5" value={data?.totalLogs || 0} label="Logs" />
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative p-6 flex items-center justify-between gap-4">
            ...
            <Link href="/subscription">
              <Button size="sm" className="shrink-0 bg-white hover:bg-zinc-200 text-black shadow-lg shadow-indigo-600/30">
                Upgrade
              </Button>
            </Link>
          </div>
