    ...
    >
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-line bg-card p-6">
          <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-faint">{PLANS.monthly.label}</p>
          <p className="mt-2 font-mono text-3xl font-medium tracking-tight text-ink">
        ...
        <div className="rounded-xl border border-green-line bg-green-tint p-6">
          <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-green">{PLANS.annual.label}</p>
          <p className="mt-2 font-mono text-3xl font-medium tracking-tight text-ink">
            ${PLANS.annual.priceUsd}
            <span className="text-base font-normal text-faint"> / first year</span>
          </p>
          <p className="mt-3 text-[14px] leading-relaxed text-soft">
      ...
      <div className="mt-10 space-y-8">
        ...
        <section>
          ...
          <p className="mt-2 text-[15px] leading-relaxed text-soft">
            ...
            <Link href="/" className="font-medium text-ink underline underline-offset-2">the waitlist on the homepage</Link>.
