# Chrome Web Store submission kit — SatyaShift v2.7.0
...
The upload file is **`dist/satyashift-extension-2.7.0.zip`** (already built; its manifest
...
1. Click **New item** → upload `dist/satyashift-extension-2.7.0.zip`.
