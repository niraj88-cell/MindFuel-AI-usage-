# Chrome Web Store submission kit — SatyaShift v2.7.2
...
The upload file is **`dist/satyashift-extension-2.7.2.zip`** (already built; its manifest
...
1. Click **New item** → upload `dist/satyashift-extension-2.7.2.zip`.
